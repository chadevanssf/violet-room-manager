...
module.exports.script = function(_appName) {
  ...
  violet._app.launch( function( requ, resp ) {
    // See https://github.com/salesforce/violet-conversations/issues/3
    return violet.inputMgr._processIntent(requ, resp, null, (response)=>{
      ...
      //   return;
      // }
      // See https://github.com/salesforce/violet-conversations/issues/5
      response.say(['How can I help?', 'Hello, ready to help']);
    });
  });
